...
const CANDIDATE_TRANSITIONS = {
  ...
  'SHORTLISTED': ['INTERVIEW_SCHEDULED', 'REJECTED', 'ON_HOLD', 'WITHDRAWN', 'SLOTS_NOT_PUBLISHED', 'SLOTS_PUBLISHED'],
  'INTERVIEW_SCHEDULED': ['INTERVIEWED', 'REJECTED', 'ON_HOLD', 'WITHDRAWN'],
  'INTERVIEWED': ['SHORTLISTED', 'INTERVIEW_SCHEDULED', 'OFFERED', 'REJECTED', 'ON_HOLD', 'WITHDRAWN', 'SLOTS_NOT_PUBLISHED'],
  ...
  'SLOTS_NOT_PUBLISHED': ['SLOTS_PUBLISHED', 'REJECTED', 'ON_HOLD', 'WITHDRAWN'],
  'SLOTS_PUBLISHED': ['SLOT_ASSIGNED', 'SLOT_DETAILS_SHARED', 'REJECTED', 'ON_HOLD', 'WITHDRAWN'],
  'SLOT_ASSIGNED': ['SLOT_DETAILS_SHARED', 'RESCHEDULE_REQUESTED', 'REJECTED', 'ON_HOLD', 'WITHDRAWN'],
  'SLOT_DETAILS_SHARED': ['INTERVIEWED', 'RESCHEDULE_REQUESTED', 'REJECTED', 'ON_HOLD', 'WITHDRAWN'],
  'RESCHEDULE_REQUESTED': ['SLOT_DETAILS_SHARED', 'REJECTED', 'ON_HOLD', 'WITHDRAWN']
};
