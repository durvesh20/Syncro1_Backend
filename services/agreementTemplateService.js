...
<style>
  ...
  * {
  ...
  h1, h2, h3, h4, .article-title, .schedule-title {
    page-break-after: avoid;
  }
...
<!-- ======================================================
     COVER BLOCK
     ====================================================== -->
<div class="main-title">SYNCRO1 TECHNOLOGIES PRIVATE LIMITED</div>
<div class="sub-title">MASTER STAFFING PARTNER (VENDOR) AGREEMENT</div>
<p class="confidential">STRICTLY CONFIDENTIAL &mdash;&mdash;&mdash; LEGALLY BINDING DOCUMENT</p>
<hr class="hr-double">
<p class="dated-line">Dated: <strong>${formattedDate}</strong></p>
<hr class="hr-single">
...
<div class="parties-block">
  ...
  <p>Syncro1 and the Vendor are hereinafter individually referred to as a <strong>&ldquo;Party&rdquo;</strong> and collectively as the <strong>&ldquo;Parties.&rdquo;</strong></p>
</div>
...
<p class="recital"><strong>WHEREAS:</strong></p>
<p class="recital"><strong>A.</strong> Syncro1 operates a proprietary AI-driven digital staffing platform (the <strong>&ldquo;Platform&rdquo;</strong>) that connects client-employers with verified staffing partners for the purpose of recruitment and placement of professional candidates on an outcome-based, success-fee model.</p>
<p class="recital"><strong>B.</strong> The Vendor is engaged in the business of recruitment, staffing, and placement of candidates, and desires to participate on the Platform as an approved Staffing Partner to access Client Job Postings, submit Candidate profiles, and earn Commissions on Successful Placements.</p>
<p class="recital"><strong>C.</strong> The Parties intend that this Agreement shall exclusively govern the terms and conditions upon which the Vendor accesses and uses the Platform and participates in the recruitment ecosystem operated by Syncro1.</p>
<p class="recital"><strong>D.</strong> In consideration of the mutual covenants, representations, warranties, and obligations set forth herein, and for other good and valuable consideration, the sufficiency and receipt of which are hereby acknowledged, the Parties agree as follows.</p>
...
<p class="clause"><strong>1.16 &ldquo;Quality Check&rdquo; or &ldquo;QC&rdquo;</strong> means the multi-layered validation process performed by Syncro1&rsquo;s automated systems and Sub Admin team to assess Candidate submissions for completeness, authenticity, duplication, and alignment with Job Posting requirements before publication to the Client.</p>
<p class="clause"><strong>1.17 &ldquo;Service Level Agreement&rdquo; or &ldquo;SLA&rdquo;</strong> means the time-bound operational obligations of the Vendor as enumerated in Schedule B, non-compliance with which may result in consequences specified therein.</p>
...
<div class="sub-heading">3A. Registration, Onboarding, and KYC</div>
...
<div class="sub-heading">3B. Job Selection and Candidate Submission</div>
...
<div class="sub-heading">3C. Communication and Quality</div>
...
<div class="sub-heading">4A. Vendor Representations and Warranties</div>
...
<div class="sub-heading">4B. Syncro1 Representations and Warranties</div>
...
<div class="sub-heading">5A. Commission Structure</div>
...
<div class="sub-heading">5B. Payout Terms</div>
...
<div class="sub-heading">5C. Replacement Obligation (Guarantee Period)</div>
...
<div class="sub-heading">5D. Taxes</div>
...
<p class="clause"><strong>7.3 Exclusions.</strong> Confidentiality obligations do not apply to information that: (a) is or becomes publicly available through no act or omission of the Receiving Party; (b) was rightfully known to the Receiving Party prior to disclosure; (c) is independently developed by the Receiving Party without reference to the Disclosing Party&rsquo;s Confidential Information; or (d) is rightfully received from a third party without restriction.</p>
...
<!-- ======================================================
     SIGNATURES
     ====================================================== -->
<hr class="hr-single" style="margin-top:14px;">
<div style="font-size:10.5pt; font-weight:bold; text-align:center; text-transform:uppercase; margin:8px 0;">SIGNATURES</div>
...
<div class="sig-outer">
  <table class="sig-table">
    <tr>
      <td>
        <p class="sig-party-label">FOR AND ON BEHALF OF</p>
        <p class="sig-party-name">SYNCRO1 TECHNOLOGIES<br>PRIVATE LIMITED</p>

        <p style="font-size:8.5pt; font-weight:bold; margin-bottom:3px;">Signature:</p>
        <div class="sig-blank-box"></div>

        <p class="sig-field">Name: <span class="sig-field-line">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</span></p>
        <p class="sig-field">Designation: <span class="sig-field-line">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</span></p>
        <p class="sig-field">Date: <strong>${formattedDate}</strong></p>
        <p class="sig-field">Place: <strong>Mumbai, Maharashtra</strong></p>
      </td>
      <td>
        <p class="sig-party-label">FOR AND ON BEHALF OF</p>
        <p class="sig-party-name">${vendorLegalName}</p>

        <p style="font-size:8.5pt; font-weight:bold; margin-bottom:3px;">Digitally Accepted:</p>
        <div class="sig-accepted-box">
          <p class="sig-accepted-text">&#10003; Agreement accepted electronically</p>
          <p class="sig-accepted-meta">
        ...
        <p class="sig-field">Name: <strong>${signatoryName}</strong></p>
        <p class="sig-field">Designation: <strong>${designation || 'N/A'}</strong></p>
        <p class="sig-field">Date: <strong>${formattedDate}</strong></p>
        <p class="sig-field">Place: <strong>${city || 'N/A'}, ${state || 'N/A'}</strong></p>
      </td>
    </tr>
  </table>
...
<p class="schedule-note">This Schedule forms an integral part of the Agreement.</p>

<div class="sub-heading">A1. Standard Commission</div>
...
<div class="sub-heading">A2. No Deductions or Adjustments</div>
...
<div class="sub-heading">A3. Payout Timing</div>
...
<div class="sub-heading">A4. Rate Card Changes</div>
...
<p style="margin-bottom:6px;">The Vendor agrees to comply with the following SLAs. Breaches are recorded in the Vendor&rsquo;s monthly performance report.</p>

<table>
  <tr>
    <th style="width:36%;">Obligation</th>
    <th style="width:20%;">Deadline</th>
    <th style="width:44%;">Consequence of Breach</th>
  </tr>
...
<p class="schedule-note">This Schedule sets out the data processing obligations of the Parties and forms an integral part of the Agreement.</p>

<div class="sub-heading">D1. Categories of Personal Data Processed</div>
<ul class="bullet">
...
<div class="sub-heading">D2. Purpose Limitation</div>
...
<div class="sub-heading">D3. Security Standards</div>
<ul class="bullet">
...
<div class="sub-heading">D4. Sub-Processors</div>
...
<div class="sub-heading">D5. Data Subject Rights</div>
...
<div class="sub-heading">D6. Data Breach Notification</div>
...
<div class="sub-heading">D7. Retention and Deletion</div>
...
<p style="margin-bottom:6px;">The following documents must be submitted by the Vendor during registration and maintained current throughout the Term. Failure to maintain up-to-date KYC documents is a material breach.</p>

<table>
  <tr>
    <th style="width:34%;">Document</th>
    <th style="width:30%;">Purpose</th>
    <th style="width:36%;">Format / Requirements</th>
  </tr>
...
<p class="schedule-note">This Schedule records all formally agreed amendments executed by duly authorised representatives of both Parties in accordance with Clause 17.2.</p>
...
<!-- ======================================================
     ...
     ====================================================== -->
<div class="schedule-title">VENDOR DETAILS RECORD</div>
<p class="schedule-note">Auto-generated from the Vendor&rsquo;s registered profile on the Syncro1 Platform at the time of acceptance.</p>

<div class="vendor-record">
  <div class="vendor-record-title">Vendor Profile &mdash; Syncro1 Platform Record</div>
  <div class="vendor-record-row"><span class="vendor-record-label">Legal Entity Name</span><span class="vendor-record-value"><strong>${vendorLegalName}</strong></span></div>
  <div class="vendor-record-row"><span class="vendor-record-label">Entity Type</span><span class="vendor-record-value">${vendorType}</span></div>
  <div class="vendor-record-row"><span class="vendor-record-label">Registered Address</span><span class="vendor-record-value">${vendorAddress}</span></div>
  <div class="vendor-record-row"><span class="vendor-record-label">PAN Number</span><span class="vendor-record-value">${panNumber || 'N/A'}</span></div>
  <div class="vendor-record-row"><span class="vendor-record-label">GST Number</span><span class="vendor-record-value">${gstNumber || 'N/A'}</span></div>
  <div class="vendor-record-row"><span class="vendor-record-label">CIN Number</span><span class="vendor-record-value">${cinNumber || 'N/A'}</span></div>
  <div class="vendor-record-row"><span class="vendor-record-label">Authorised Signatory</span><span class="vendor-record-value"><strong>${signatoryName}</strong></span></div>
  <div class="vendor-record-row"><span class="vendor-record-label">Designation</span><span class="vendor-record-value">${designation || 'N/A'}</span></div>
  <div class="vendor-record-row"><span class="vendor-record-label">Agreement Accepted On</span><span class="vendor-record-value"><strong>${agreedDateTime}</strong></span></div>
  <div class="vendor-record-row"><span class="vendor-record-label">IP Address at Acceptance</span><span class="vendor-record-value">${agreedIp || 'N/A'}</span></div>
</div>
...
<div class="doc-footer">
  <p>Document Reference: MSA-${Date.now()} &nbsp;&bull;&nbsp; Generated: ${new Date().toLocaleString('en-IN')} &nbsp;&bull;&nbsp; &copy; ${new Date().getFullYear()} Syncro1 Technologies Private Limited. All rights reserved.</p>
</div>
