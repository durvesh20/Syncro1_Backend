      ...
      const sampleJobs = [
        {
          ...
          description: 'We are looking for an experienced Senior Software Engineer to join our growing team. You will be responsible for designing, developing, and maintaining scalable software solutions.',
          requirements: [
        ...
        },
        {
          ...
          description: 'Join our product team to lead the development of innovative solutions. You will work closely with engineering, design, and business teams.',
          requirements: [
          ...
          skills: {
            required: ['Product Management', 'Agile', 'Data Analysis', 'Roadmapping'],
        ...
        },
        {
          ...
          description: 'Great opportunity for freshers and junior developers to kickstart their career with a leading tech company.',
          requirements: [
